...
export type { LocalizedText, Variant, RegistryEntry, RegistryJson, RegistryCategory, CategoriesJson } from './types'
export { validateRegistry, validateCategories } from './validate'
